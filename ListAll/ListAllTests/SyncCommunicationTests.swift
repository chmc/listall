...
final class SyncCommunicationTests: XCTestCase {
    ...
    func testItemsSyncRegardlessOfListModifiedAt() {
        ...
        // Simulate receiving sync from Watch
        let receivedLists = [updatedList]
        
        // Call the private method through the notification system
        NotificationCenter.default.post(
            name: NSNotification.Name("WatchConnectivityListsDataReceived"),
            object: nil,
            userInfo: ["lists": receivedLists]
        )
    ...
    func testMultipleListsSync() {
        ...
        let receivedLists = [updatedList1, updatedList2]
